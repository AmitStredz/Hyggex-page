      ...
      <div className="">
        ...
        {selectedOption && (
          <div className="mt-4">
            <div className="flex items-center justify-center">
              <div className="flex flex-col gap-32 justify-center items-center rounded-[8vh] min-w-[100vh] min-h-[57vh] bg-gradient-to-bl from-[#061B92] to-[#2082ED] p-4 m-2  text-white transition-[.5s]">
                <div className="flex w-full mt-[-140px] justify-between px-5 text-3xl font-extralight transform-[.5s]">
        ...
        <div className="flex items-center justify-between p-10 text-4xl text-blue-900 font-bold">
          ...
          <div className="flex justify-evenly items-center gap-7">
            <i className="ri-arrow-left-s-line bg-gradient-to-b from-[#062970] to-[#164EBF] text-white rounded-full p-2"></i>
            <p className="text-2xl font-bold">01/10</p>
            <i className="ri-arrow-right-s-line bg-gradient-to-b from-[#062970] to-[#164EBF] text-white rounded-full p-2"></i>
          </div>
          <div>
